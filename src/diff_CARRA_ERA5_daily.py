...
upstream:
    /Users/jason/Dropbox/CARRA/CARRA_ERA5_events/src/CARRA/extract_CARRA_rf_from_tpt2m.py
...
# read ice mask
# fn='./meta/CARRA_W_domain_ice_mask.nc'
...
if i<2:
    ...
    color_code='k'
    print()
    plt.text(xx0, yy0+cc*dy2,CARRA_or_ERA5+'\nrainfall\n'+casex2, fontsize=font_size*mult,
      transform=ax.transAxes,color=color_code) ; cc+=1.
